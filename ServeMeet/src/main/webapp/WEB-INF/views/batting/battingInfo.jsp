...
<article id="bbs-view" style="width:auto;">
	...
	<div class="bbs_title_wrap" style="">
		<a class="bbs_title" href="${pageContext.request.contextPath }/batting/battingList.ba?type=I">배팅 게시판</a>
	</div>
	...
	<div id="bbs-view-top-btn" class="bbs_view_btn_wrap">
		<div class="button_box">
			...
			<a href='${pageContext.request.contextPath }/batting/battingList.ba?type=I' class="bbs_btn btn_list">
    ...
    <section id="bo_v_atc">
        ...
        <pre style="background-color: white; white-space: pre-wrap; padding: 0px 10px;">
			...
			<h2 id="bbs-view-title">A팀 배당 : <c:if test="${batting.battingPNumA + batting.battingPNumB ne 0}"><fmt:formatNumber value="${(100-batting.battingPNumA/(batting.battingPNumA + batting.battingPNumB)*100)*15/1000 + 1}" pattern=".00"/>배</c:if>                                       B팀 배당 : <c:if test="${batting.battingPNumA + batting.battingPNumB ne 0}"><fmt:formatNumber value="${(100-batting.battingPNumB/(batting.battingPNumA + batting.battingPNumB)*100)*15/1000 + 1}" pattern=".00"/>배</c:if></h2>
        </pre>
		...
		<div>
			<input type="button" class="sb_btn2" onclick="btnBatting('A');" value="A팀 배팅<c:if test="${batting.battingPNumA + batting.battingPNumB ne 0}">(<fmt:formatNumber value="${(100-batting.battingPNumA/(batting.battingPNumA + batting.battingPNumB)*100)*15/1000 + 1}" pattern=".00"/>)</c:if>" /> 
			<input type="button" class="sb_btn2" onclick="btnBatting('B');" value="b팀 배팅<c:if test="${batting.battingPNumA + batting.battingPNumB ne 0}">(<fmt:formatNumber value="${(100-batting.battingPNumB/(batting.battingPNumA + batting.battingPNumB)*100)*15/1000 + 1}" pattern=".00"/>)</c:if>" />
		</div>
        </c:if>
        </div>
